...
public class EarthquakeCityMap extends PApplet {
	...
	private void printQuakes() 
	{
		...
		ArrayList<Marker> oceanQuakes = new ArrayList<Marker>();
		...
		for (Marker m : quakeMarkers) {
			//cast Marker as EarthquakeMarker because I know the underlying object is an EarthquakeMarker
			EarthquakeMarker em = (EarthquakeMarker)m;
			if(em.isOnLand()) {
				String Country = (String)m.getProperty("country");
		...
		for (String country : map.keySet()) {
			if (map.get(country) > 0) {
				System.out.println(country + " had " + map.get(country) + " Earthquakes.");
			}
			
		}
		System.out.println(oceanQuakes.size() + " Quakes in the ocean.");
